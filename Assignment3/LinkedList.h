...
#ifndef LINKEDLISTTEMPLATE_LINKEDLIST_H_
#define LINKEDLISTTEMPLATE_LINKEDLIST_H_
 ...
 *******************/
     ...
     * -------------------------------------------------------------------------
     * This will allow the client to utilize the subscript operator.
     */
    typeName& operator[] (const int nIndex);
...
template<class typeName>
typeName& List<typeName>::operator[] (const int nIndex)
{
...
#endif /* LINKEDLISTTEMPLATE_LINKEDLIST_H_ */
