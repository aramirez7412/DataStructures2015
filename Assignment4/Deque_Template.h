...
#ifndef DEQUE_TEMPLATE_H_
#define DEQUE_TEMPLATE_H_
...
public:
	...
	****************************************************************************/
	void insertBack(const typeName& data);
	...
	****************************************************************************/
	bool eraseFront(typeName & poppedData);
...
****************************************************************************/
template<class typeName>
void Deque<typeName>::insertBack(const typeName & data)
{
...
****************************************************************************/
template<class typeName>
bool Deque<typeName>::eraseFront(typeName & poppedData)
{
	//D E C L A R A T I O N S
...
****************************************************************************/
template <class typeName>
bool Deque<typeName>::pop_back(const typeName & poppedData)
{
	//D E C L A R A T I O N S
	bool isEmpty; // Processing - This boolean will be returned from the
				  //			  method and will determine if the
...
****************************************************************************/
template<class typeName>
typeName Deque<typeName>::peek_front()
{
	if(_head != NULL)
	{
...
****************************************************************************/
template<class typeName>
typeName Deque<typeName>::peek_back()
{
	if(_tail != NULL)
	{
...
****************************************************************************/
template<class typeName>
void Deque<typeName>::outputList()
{
	//D E C L A R A T I O N S
...
****************************************************************************/
template<class typeName>
void Deque<typeName>::DestroyList()
{
	delete _head;
}
#endif /* DEQUE_TEMPLATE_H_ */
